...
public final class Constants {
  ...
  public static final Set<String> limelightCameras = Set.of("limelight-fl,limelight-fr,limelight-back");
  ...
  public static final Distance robotScoringOffset = Inches.of(34.5).div(2.0);
